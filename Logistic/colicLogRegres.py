...
Modify:
	2017-11-15 by Cugtyt 
		...
		* Email(cugtyt@qq.com)
		Use random initialization, and random index, 
		delete used data is not needed.
	2017-09-05
"""
...
Modify:
    2017-11-15 by Cugtyt 
		* GitHub(https://github.com/Cugtyt) 
		* Email(cugtyt@qq.com)
		Simplify for by list comprehension, and if... by compute directly.
	2017-09-05
"""
def colicTest():
	...
	for line in frTest.readlines():
		...
		currLine = line.strip().split('\t')
		lineArr = [float(currLine[i]) for i in range(len(currLine) - 1)]
		errorCount += int(classifyVector(np.array(lineArr), trainWeights)) != int(currLine[-1])
	errorRate = (errorCount / numTestVec) * 100 								#错误率计算
...
Modify:
    2017-11-15 by Cugtyt 
		* GitHub(https://github.com/Cugtyt) 
		* Email(cugtyt@qq.com)
		Simplify for by list comprehension.
	2017-09-05
"""
def colicSklearn():
	frTrain = open('horseColicTraining.txt')										#打开训练集
